  ...
  return (
    <div className="p-[60px]">
        ...
        <div className="flex items-center justify-center w-full flex-col">
            {chanceInfo && (
                <div className="flex absolute top-20 flex-row space-x-3 items-center justify-between pl-5 rounded-[8px] border-[1px] border-[#282828] max-sm:w-[80%] max-sm:top-24 w-[421px] h-[52px] bg-black">
        ...
        <div className=" md:absolute bottom-10 max-sm:flex max-sm:items-center max-sm:justify-center max-sm:py-10 left-[43.5%]">
