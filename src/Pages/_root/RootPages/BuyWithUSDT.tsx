...
import BoughtTokensSuccess from '@/components/shared/BoughtTokensSuccess.tsx';
import { USDTABI } from '@/components/shared/Constants/TokenABI.ts';
...
import BoughtTokensFailed from '@/components/shared/BoughtTokensFailed.tsx';
...
const BuyWithUSDT = (props : any) => {
  ...
  useEffect(() => {
    if (isConfirmed && props.fullTransaction) {
      ...
      // Trigger the mutation for the POST request
