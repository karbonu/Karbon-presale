                    ...
                    <div className="w-full py-5 flex flex-col space-y-5 items-center justify-center">
                        ...
                        <div className="flex flex-col items-center justify-center space-y-2">
                            <div className="flex flex-row space-x-2">
                                <p className="text-[#08E04A] font-medium text-[32px] max-sm:text-[24px]">{props.tokenAmount}</p>
                                <p className="text-[#08E04A] text-[32px] max-sm:text-[24px] opacity-50">USDT</p>
                            </div>
                            <p className="text-[14px] text-white opacity-70">{t('payoutProcessing')}</p>
                        </div>
                        <p className="text-center text-white w-[251px] text-[14px] max-sm:text-[12px] leading-6 tracking-normal">{t('payoutRequestReceived')}</p>
