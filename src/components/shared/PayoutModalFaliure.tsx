  ...
  return (
    <div>
        <Dialog open={props.isDialogOpen} onOpenChange={props.setIsDialogOpen}>
            <DialogContent className='bg-[#101010] border-[1px] border-[#282828] py-10  flex flex-col w-[412px] items-center justify-center rounded-[16px] outline-none'>
                ...
                <div className="w-full py-5 flex flex-col space-y-6">
                    ...
                    <div className="flex flex-col  space-y-2 px-8">
                      <div className="flex fle-row w-max items-center py-2 px-4 bg-black space-x-10">
                        <div>
